...
extension PrototypeLevel1 {
    ...
    func presentIntro2() {
        presentMessages([
            ...
            .init(text: "The probe is very fragile. Engineering had to cut some corners..."),
            ...
            .init(text: "..."),
            .init(text: "Please be careful with the probe. They are pretty expensive okay?"),
            .init(text: "Now, for the mission briefing, you'll need to retrieve shards of Tospium scattered on the site."),
            .init(text: "We've detected \(detectedGemCount) Topsium shards around here."),
